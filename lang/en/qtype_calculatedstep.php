...
/**
 * Strings for component 'qtype_calculatedstep', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
...
$string['pluginname'] = 'Stepwise Calculated and Description';
...
$string['pluginname_link'] = 'question/type/calculatedstep';
$string['pluginnameadding'] = 'Adding a SCAD question';
$string['pluginnameediting'] = 'Editing a SCAD question';
...
$string['privacy:metadata'] = 'The SCAD question type plugin does not store any personal data.';
$string['setno'] = 'Set {$a}';
